...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($username) && !preg_match('/^[a-z0-9_-]{5,30}$/', $username)) {
    array_push($error, "Username must starts with letter and consist of at least 5 letters and numbers! Please Try Again!");
  ...
  if (!empty($phone) && (!preg_match('/^[0-9]+$/', $phone) || strlen($phone) < 7 || strlen($phone) > 8)) {
    array_push($error, 'Incorrect phone number! Please Try Again!');
    // $phoneError=true;
    $valid = false;
  }
  if ((!preg_match('/^[0-9]+$/', $nric) || strlen($nric) != 12) && $nationality == "Malaysian" && !empty($nric)) {
  ...
  <div class="card bg-light">
    <article class="card-body mx-auto" style="max-width: 700px;">
      ...
      <div class="alert alert-success">
        ...
        <ul>
          <li>Username must starts with letter and consist of at least 5 letters and numbers</li>
          <li>NRIC must only contains letters </li>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        ...
        <div class="form-group input-group">
          ...
          <input id="name" name="name" class="form-control" required placeholder="Full name" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
          <div class="input-group-prepend">
            <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
          </div>
          <input id="email" name="email" class="form-control" required placeholder="Email address" type="email">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
          <div class="input-group-prepend">
            <span class="input-group-text"> <i class="fa fa-phone"></i> </span>
          </div>
          <select id="prefix" name="prefix" class="custom-select" required style="max-width: 120px;">
          ...
          <input id="phone" name="phone" class="form-control" required placeholder="Phone number" type="text">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
          <div class="input-group-prepend">
          ...
          <input id="nric" name="nric" class="form-control" required placeholder="NRIC" type="text">
        ...
        <div id="dob_form" class="form-group input-group">
          ...
          <input type="text" class="form-control" name="dob" required width="276" onfocus="(this.type='date')" placeholder="Date of Birth" />
        </div>
        ...
        <div class="form-group input-group">
          ...
          <textarea id="address" name="address" required class="form-control" placeholder="Home address" type="text" rows="4"></textarea>
        </div> <!-- form-group// -->
        <div class="form-group input-group">
          <div class="input-group-prepend">
        ...
        <div class="form-group input-group">
          ...
          <input name="password" id="password" class="form-control" required placeholder="Create password" type="password">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
          <div class="input-group-prepend">
            <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
          </div>
          <input name="password_verify" id="password_verify" class="form-control" required placeholder="Repeat password" type="password">
        </div> <!-- form-group// -->
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>Copyright &copy;<script>
          ...
          </script> All rights reserved - HealthInsider</p>
      </div>
    </div>
  </div>
