...
?>
    ...
    <div class="container-fluid mt-5">
      <div class="container">
       <div class="row">
         <div class="col-md">
           <img class="img-fluid" src="images\unsplash1.jpg" >
         </div>
         <div class="col-md text-left mt-5 ml-5">
          <h1>Welcome to our clinic</h1>
          <p>HealthInsider is a not-for-profit independent hospital that located in Petaling Jaya. We are open to all patients every day.</p>
  ...
  <div class="container mt-5 mb-5">
    <p>HealthInsider is anchored by more than 890 doctors and 2,800 nurses in Malaysia, delivering quality, service and value through a full spectrum of integrated healthcare services and a wide range of ancillary services including laboratory and rehabilitation.
      <br><br>
      Leveraging on a strong track record of managing world-class hospitals, HealthInsier continues to make a difference in people’s lives through excellent patient care, while steadily expanding its reach in markets where demand for quality care is strong and growing.</p>
  </div>
<hr>
