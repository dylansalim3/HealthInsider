      ...
      if ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!$pwcheck) {
          ...
          if ($role == "Staff" && !empty($row['STAFF_ID'])) {
            ...
            header("Location:db_staff_dashboard.php");
            exit();
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        <?php if (isset($_GET['error'])) {
          ...
          if ($_GET['error'] == "emptyfields") {
            ...
            echo "Please insert the correct credential";
          } else if ($_GET['error'] == "wrongpwd") {
            echo "Please select the correct password";
          } else if ($_GET['error'] == "sqlerror") {
            echo "There is a sql error, please try again later";
          } else if ($_GET['error'] == "nouser") {
            echo "Please enter an email with existing account";
          }
          echo "</div>";
        } ?>
        <div class="form-group input-group">
          ...
          <input name="email" class="form-control" required placeholder="Enter your email" type="text">
        </div> <!-- form-group// -->
        ...
        <div class="form-group input-group">
          ...
          <input name="password" class="form-control" required placeholder="Enter your password" type="password">
        </div> <!-- form-group// -->
        <div class="form-group input-group">
