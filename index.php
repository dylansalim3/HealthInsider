...
<div class="mycontainer">
    ...
    <div class="jumbotron jumbotron-fluid mt-5 mb-0 hotline">
      <div class="container text-center ">
        <h1 class="display-4">Emergency hotline</h1>
        <h1 class="display-4">(+04) – 256 567 550</h1>
        <p class="lead">We provide 24/7 customer support. Please feel free to contact us for emergency case.</p>
      </div>
    </div>
